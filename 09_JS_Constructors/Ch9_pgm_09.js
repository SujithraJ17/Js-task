...
var Player = function (name, health) {
  ...
  this.getPlaceInfo = function () {
      return this.name + " is in " + (this.place ? this.place.title : "nowhere");
  };
...
var player2 = new Player("Lena", 75);
player2.place = library;
player2.addItem("a magic scroll");
player2.addItem("an ancient tome");

var player3 = new Player("Marek", 60);
player3.place = library;
player3.addItem("a potion of healing");
player3.addItem("a map of the realm");
...
console.log(player1.name + " dropped: " + player1.dropItem());
player1.showInfo("=");

console.log(player2.name + " dropped: " + player2.dropItem());
player2.showInfo("#");

console.log(player3.name + " dropped: " + player3.dropItem());
player3.showInfo("*");
